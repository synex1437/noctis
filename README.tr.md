...
| Bir eşik yanlışlıkla saçma bir değere çekilir | O pencereyi varsayılan eşik korumaya devam eder; `noctis status`, `noctis doctor` ve sonraki oturum pencerenin adını söyler. Bir pencereyi gerçekten korumasız bırakmak isterseniz eşiği `0` ya da `null` yapın. |
